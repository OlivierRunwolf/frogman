...
Frogman exposes 209 tools via HTTP API. Bots, web apps, and integrations can execute these tools remotely. Tools cannot be created or modified via the API — only executed based on your permission level.
