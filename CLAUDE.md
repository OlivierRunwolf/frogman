...
Frogman is a FreePBX module (`/var/www/html/admin/modules/frogman/`) that provides chat-driven headless control of FreePBX. It exposes 210 tools through a registry pattern accessible via CLI, HTTP API, GraphQL, and MCP.
